...
<head>
    ...
    <title>Registrarse · ShopLaravel</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-submit { width: 100%; background: var(--orange); color: var(--white); border: none; padding: 0.85rem; border-radius: 10px; font-family: 'Syne', sans-serif; font-size: 1rem; font-weight: 700; cursor: pointer; transition: background 0.2s, transform 0.15s, box-shadow 0.2s; margin-top: 0.5rem; }
        ...
        @media (max-width: 768px) { .auth-left { display: none; } .auth-right { padding: 1.5rem; } body { overflow: auto; } .auth-form-row { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
    <div class="auth-page">
        <div class="auth-left">
            ...
            <div class="auth-left-content">
                ...
                <h2>Únete a ShopLaravel</h2>
                <p>Crea tu cuenta y descubre<br>algo increíble</p>
